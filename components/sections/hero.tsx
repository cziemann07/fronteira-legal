      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-16 md:px-6 md:py-24 lg:grid-cols-2 lg:gap-16">
        <div className="flex flex-col gap-6">
          ...
          <Reveal className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <a
              href="#como-funciona"
              className="inline-flex h-12 items-center justify-center rounded-md border border-border bg-background px-6 text-base font-medium text-foreground transition-[background-color,transform,border-color] duration-150 hover:-translate-y-px hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              {t.hero.ctaSecondary}
            </a>
          </Reveal>
